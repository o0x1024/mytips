...
async function selectCertificateDirectory() {
  try {
    const result = await invoke('dialog', {
      cmd: 'open',
      options: {
        directory: true,
        multiple: false,
        title: t('dataSettings.certificateManagement.selectDirectoryTitle')
      }
    }) as string | null
  ...
  try {
    const result = await invoke('dialog', {
      ...
      options: {
        directory: true,
        multiple: false,
        title: t('dataSettings.jwtManagement.selectDirectoryTitle')
      }
    }) as string | null
