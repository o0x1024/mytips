<template>
  <div class="h-full flex flex-col bg-base-200 border-r border-base-300 transition-all duration-300"
    ...
    <div class="p-4 flex items-center justify-between">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" class="h- w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="overflow-y-auto flex-grow px-2">
      ...
      <div class="mb-1">
        ...
        <div v-if="isCollapsed" class="flex flex-col gap-1 my-2 items-center">
          <button 
            class="btn btn-ghost btn-sm btn-square w-9 flex justify-center tooltip tooltip-right" 
    ...
    <div class="mt-auto p-2 flex flex-col" :class="{'items-center': isCollapsed}">
      ...
      <button 
        :class="['btn mb-2', isCollapsed ? 'btn-ghost btn-sm btn-square' : 'btn-outline w-full']"
      ...
      <button 
        :class="['btn mb-2', isCollapsed ? 'btn btn-ghost btn-sm btn-square w-9 flex justify-center tooltip tooltip-righ' : 'btn-outline w-full']" 
      ...
      <button 
        :class="['btn', isCollapsed ? 'btn btn-ghost btn-sm btn-square w-9 flex justify-center tooltip tooltip-righ' : 'btn-outline w-full']" 
...
function deleteTag(tagId: string) {
  // 确认对话框
  if (confirm('确定要删除此标签吗？这将从所有笔记中移除该标签。')) {
